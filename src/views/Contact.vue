    ...
    <div id="background">
      ...
      <div id="heading">
        <h2>
            ...
            <div class="col-md-6 col-xl-6 col-sm-12 col-xm-12">
             <form class="w-75-xl w-100-md   form-wrapper" action="https://formspree.io/f/xknykjpb" method="post" target="_blank"> 
              ...
              <div id="btn" class="mt-5 submitbtn">
        ...
        <div id="info" class="col-md-6 col-xl-6 col-sm-12 col-xm-12">
                  <ul>
                      <li>
                         <span>Call:</span>  +27(0)83 598 9156
                      </li>
                      <li>
                        <span>Email:</span>mogamatsmustangs@gmail.com   
                      </li>
                      <li>
                         <span> Address:</span> 
                      </li>
                      ...
                      <div class="wrap">
  <div class="box">
    <svg class="car" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98.967 98.967">
	<g class="car__wheels">
    <g class="car__wheel">
...
.car {
  animation: ride 15s infinite linear;
